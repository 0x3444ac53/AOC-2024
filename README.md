...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `148.7µs` | `167.6µs` |
| [Day 2](./src/bin/02.rs) | `385.0µs` | `742.4µs` |
| [Day 3](./src/bin/03.rs) | `510.6µs` | `941.5µs` |
| [Day 4](./src/bin/04.rs) | `7.3ms` | `4.6ms` |
| [Day 5](./src/bin/05.rs) | `9.8ms` | `10.1ms` |
